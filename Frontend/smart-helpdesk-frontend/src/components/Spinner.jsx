    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 text-gray-800 px-4">
      <div className="text-center">
        <h1 className="text-2xl sm:text-3xl font-bold mb-4">
          Redirecting you in <span className="text-blue-600">{count}</span>{" "}
          second{count !== 1 && "s"}...
        </h1>
        ...
        {/* Progress bar */}
        <div className="flex justify-center w-100 bg-gray-200 rounded-full h-2 overflow-hidden">
          <div
        ...
        <p className="flex justify-center mt-4 text-gray-600 text-sm">
